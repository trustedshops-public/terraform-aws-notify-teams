...
# todo: Remove `this_teams_topic_arn` output during next major release 5.x
output "this_teams_topic_arn" {
  description = "The ARN of the SNS topic from which messages will be sent to Teams (backward compatibility for version 4.x)"
  value       = local.sns_topic_arn
}
