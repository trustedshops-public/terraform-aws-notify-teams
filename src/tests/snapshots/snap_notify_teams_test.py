...
snapshots[
    "test_event_get_teams_message_payload_snapshots event_cloudwatch_alarm.json"
] = [
    {
        "attachments": [
            {
...
snapshots[
    "test_event_get_teams_message_payload_snapshots event_guardduty_finding_high.json"
] = [
    {
        "attachments": [
            {
...
snapshots[
    "test_event_get_teams_message_payload_snapshots event_guardduty_finding_low.json"
] = [
    {
        "attachments": [
            {
...
snapshots[
    "test_event_get_teams_message_payload_snapshots event_guardduty_finding_medium.json"
] = [
    {
        "attachments": [
            {
...
snapshots[
    "test_sns_get_teams_message_payload_snapshots message_cloudwatch_alarm.json"
] = [
    {
        "attachments": [
            {
...
snapshots[
    "test_sns_get_teams_message_payload_snapshots message_dms_notification.json"
] = [
    {
        "attachments": [
            {
...
snapshots[
    "test_sns_get_teams_message_payload_snapshots message_glue_notification.json"
] = [
    {
        "attachments": [
            {
...
snapshots[
    "test_sns_get_teams_message_payload_snapshots message_guardduty_finding.json"
] = [
    {
        "attachments": [
            {
...
snapshots["test_sns_get_teams_message_payload_snapshots message_text_message.json"] = [
    {
        "attachments": [
            {
                "fallback": "A new message",
